...
public class Compare implements Runnable {
  ...
  private BufferedImage capTemp1;
  private BufferedImage capTemp2;
  private BufferedImage startBufImg;
  private BufferedImage endBufImg;
  private static boolean exit;
  private boolean getNextPage;
  private boolean capNoteStart;
  private boolean capNoteFinish;
...
//	private int pdfPage;
  ...
  public Compare(ArrayList<BufferedImage> originPDFArray, Capturing cap, LaController LAC) {
